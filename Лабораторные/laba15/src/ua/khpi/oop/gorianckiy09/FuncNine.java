...
public class FuncNine {
	...
	public static void ChooseMenu() {
		...
		System.out.println("11. Thread");
		System.out.println("12. JavaContainer");
		System.out.println("0. Exit");
		System.out.println("Write:");
	}
	public static void ChoooseMenu1() {
		System.out.println("\n\nChoose what you want to do:");
		System.out.println("1. Delete from  Container");
		System.out.println("2. Add to our directory new data");
		System.out.println("3. Output container to screen ");
		System.out.println("4. Check for emptiness");
		System.out.println("5. Output from File");
